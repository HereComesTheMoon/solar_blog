...
Shamelessly torn out of https://github.com/hbldh/hitherdither since:
- The github doesn't seem to be under active development.
- It's not on eg. PyPi, so package management is a pain. For Nix it required me to write my own package.
- I worked on rewriting the code for dithering to make a few changes.
